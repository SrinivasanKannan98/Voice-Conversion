...
training = input('Enter 1 to train a new model, 0 to use a trained model : '); 
method = input('Enter the Method of Voice Conversion {''Method 1'', ''Method 2'', ''Default''} : '); 
