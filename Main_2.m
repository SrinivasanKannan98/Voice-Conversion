...
audiowrite(strcat('Converted_Method 1_',pr,'_',conv,'_',num2str(lpcOrder),'.wav'),...
    morph,fs_test);
...
save('Trained Model_Method 1_' + pr + '_' + conv + '_LPC Order' + ' ' + num2str(lpcOrder),'netLSF');
save('F0 Array_Method 1_' + pr + '_' + conv + '_LPC Order' + ' ' + num2str(lpcOrder),'F0_s','F0_t');
save('Results_Method 1_' + pr + '_' + conv + '_LPC Order' + ' ' + num2str(lpcOrder) + '.txt','MCD','PLSF','-ascii');
saveas(f,'Waveforms_Method 1_' + conv + '_' + pr + '_LPC Order' + ' ' + num2str(lpcOrder) + '.jpg');
saveas(f1,'Spectrograms_Method 1_' + conv + '_' + pr + '_LPC Order' + ' ' + num2str(lpcOrder) + '.jpg');