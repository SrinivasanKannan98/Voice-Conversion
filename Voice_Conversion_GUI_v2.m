classdef Voice_Conversion_GUI_v2 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.PlayConvertedSpeechButton.Visible = 'off';
            app.PlayValidationSpeechButton.Visible = 'off';
        ...
        function ConvertButtonPushed(app, event)
            ...
            if(app.UIAxes.Position(3) ~= 257)
                wsf = 257/128;
                app.PlayConvertedSpeechButton.Position(3) = floor(app.UIAxes.Position(3) / wsf);
                app.PlayValidationSpeechButton.Position(3) = floor(app.UIAxes.Position(3) / wsf);
                app.PlayValidationSpeechButton.Position(1) = app.UIAxes.Position(1) + app.UIAxes.Position(3) - 8 ...
                    - app.PlayValidationSpeechButton.Position(3) + 12;
            end
        ...
        function PlayConvertedSpeechButtonPushed(app, event)
            ...
            if(strcmp(app.UIAxes.Visible,'off'))
                ...
                app.PlayConvertedSpeechButton.Visible = 'on';
                app.PlayValidationSpeechButton.Visible = 'on';
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ConvertButton.Position = [219 89 136 22];
            ...
            app.UIAxes_2.ZTick = [];
            app.UIAxes_2.Position = [7 8 257 185];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Voice_Conversion_GUI_v2
